...
# =============================================================================
#  焼きなましの繰り返し のパラメータを optuna で自動調整するスクリプト
# =============================================================================
#  【使い方】
...
#
#  【main.cpp のパラメータ対応】
#    p1 : TEMP_START       1 ラウンド目の開始温度
#    p2 : TEMP_END         1 ラウンド目の終了温度
#    p3 : NUM_ROUNDS       繰り返し回数(時間をこの数で等分)
#    p4 : TEMP_DECAY       ラウンドごとに温度に掛ける係数
...
def generate_params(trial: optuna.trial.Trial) -> dict[str, str]:
    ...
    params = {
        ...
        # p4: ラウンドごとの温度の減衰率
        "p4": str(trial.suggest_float("p4", 0.3, 1.0)),
