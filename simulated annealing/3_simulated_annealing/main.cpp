...
// ★温度はスコアのスケールに強く依存する。まずは
//    開始温度 TEMP_START ≒ 受け入れたい悪化量の最大値
//    終了温度 TEMP_END   ≒ 無視したい悪化量 (これ以下の悪化しか受け入れなくなる)
//  くらいから始めて optuna で詰めると良い。
float TEMP_START = 50.0f;   // p1: 開始温度
float TEMP_END   = 1.0f;    // p2: 終了温度
float P_ORO      = 0.30f;   // p3: 近傍の選び方 (デモ: or-opt を選ぶ確率)
